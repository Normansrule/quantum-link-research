...
Bouwmeester 1997 (photons) → Furusawa 1998 (CV, unconditional) → Riebe/Barrett 2004 (ions) → Pfaff 2014 (NV, unconditional solid state) → Ren 2017 (ground-to-satellite) → Hermans 2022 (non-neighbouring nodes via swapping and memory). Details and step-by-step accounts: `docs/hardware_and_experiments_guide.md` §3.
