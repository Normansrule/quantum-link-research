...
**Physics.** `01_quantum_computing_core/03`: $p_L\propto(p/p_{\rm th})^{(d+1)/2}$; the experiments measure $\Lambda$ directly.
...
**Repo hook.** Stim stubs for Phase 4 repeater-generation comparison; `04_cutting_edge/01` timeline.
