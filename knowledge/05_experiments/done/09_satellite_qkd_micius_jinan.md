...
**Physics.** `03_quantum_communication/04`: diffraction-limited link budget, pointing, background, decoy-state rate. Step-by-step: `docs/hardware_and_experiments_guide.md` §3.4.
