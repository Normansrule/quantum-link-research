...
**Physics.** Spin–photon entanglement from spin-selective resonant excitation; heralding by a two-photon coincidence pattern; success $p\sim10^{-4}$–$10^{-6}$ per attempt; memory in ¹³C nuclear spins. Step-by-step protocol in `docs/hardware_and_experiments_guide.md` §3.3.
