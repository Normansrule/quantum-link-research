...
## In this repo
Proposal E6 (QRNG bases) and E2 (NV $T_1,T_2$ vs $T$) are sensing experiments in disguise; the Uncut Gem build in `docs/hardware_and_experiments_guide.md` is a magnetometer.
