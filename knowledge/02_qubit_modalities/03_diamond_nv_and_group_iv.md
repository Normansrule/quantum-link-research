...
The bench-buildable qubit and the platform with the strongest *network* record. The full hardware treatment (parts, vendors, budget tiers, step-by-step experiments) is in `docs/hardware_and_experiments_guide.md`; this file is the physics.
