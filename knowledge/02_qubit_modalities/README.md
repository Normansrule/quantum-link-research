...
| Topological (Majorana) | parity of a pair of Majorana zero modes in a superconductor–semiconductor wire | 10–50 mK | topologically protected in theory | — | not demonstrated | 0 verified logical qubits | none | contested: see `05_experiments/lessons/` |
...
For a bench-scale build the only affordable modality is the diamond NV ensemble (about $100–$500, `docs/hardware_and_experiments_guide.md`); the photonic bench (SPDC, ~$5k+) is the affordable *flying*-qubit platform.
