...
## In this repo
`qll/circuits/bell.py`, `chsh.py` (Phase 2); `hardware/randomness.py` supplies settings (invariant INV-7 in `docs/physics_module_design.md`). Bench version: `05_experiments/done/03_bell_test_spdc.md`.
