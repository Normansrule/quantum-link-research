...
| C14 | ~~photon_source, detector, beam_splitter, nv_node~~ done in 0.6.0; Perceval adapter 0.11.0; frequency conversion 0.21.0 | ★★ | learn 00/12, 02/03, 02/06 |
...
| C17 | ~~qll/space: Kepler ephemeris, conjunction, relay constellation, platform thermal, classical link~~ done in 0.9.0; Horizons CSV loader present; relativistic corrections added in 0.20.0 (`space/relativity.py`); Jinan-1 fit pipeline ready (0.19.0), data download remains | ★★★ | learn 02/10, T05, T06 |
...
| R2 | E8 modality trade study with data and sensitivity analysis (E7 half done in 0.15.0: transduction trade) | ★★★ | `systems/trade_studies.md` + figure |
