...
**Physics.** `learn/03_quantum_communication/02`; the two classical bits here are the "which detectors clicked" record; the linear-optics BSM identifies at most two of four Bell states.
