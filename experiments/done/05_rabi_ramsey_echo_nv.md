...
**Physics.** `learn/00_foundations/04`: $P_1(t)=\sin^2(\Omega t/2)$ on resonance; Ramsey gives $T_2^*$ and detuning; echo gives $T_2$; CPMG with $N$ pulses gives $T_2\propto N^{2/3}$ in a P1-center bath (de Lange 2010).
