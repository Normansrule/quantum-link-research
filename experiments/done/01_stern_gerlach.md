...
**Physics.** Force $F_z=\mu_z\,\partial B_z/\partial z$ with $\mu_z=\pm g\mu_B/2$; the two outputs are the eigenstates of $S_z$. Sequential Stern–Gerlach devices along $z$, then $x$, then $z$ show that measuring $S_x$ erases the $S_z$ information: non-commuting observables, the content of `learn/00_foundations/02`.
