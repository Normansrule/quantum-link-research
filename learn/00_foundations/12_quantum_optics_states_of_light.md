...
- **Second-order correlation** $g^{(2)}(0)=\frac{\langle a^{\dagger2}a^2\rangle}{\langle a^\dagger a\rangle^2}$: 1 for coherent light, 2 for thermal, 0 for a single photon (antibunching, `../../experiments/done/02`).
