...
## In this repo
`qll/viz/rabi_ramsey.py`; Phase 2 `noise/phase_damping.py` encodes $1/T_2=1/2T_1+1/T_\varphi$; the NV teaching-lab build is Tier 1 in `experiments/bench/hardware_guide.md`.
