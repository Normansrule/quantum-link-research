...
def test_topic_files_cite_something(path):
    text = path.read_text(encoding="utf-8")
    if path.parent.name in ("youtube", "chapters", "results") or path.name == "README.md" or path.name in {"01_state_of_the_art_timeline.md", "02_open_problems.md", "00_GLOSSARY.md", "00_MISCONCEPTIONS.md", "BACKLOG.md", "DESIGN_PROCESS.md", "INDEX.md", "_TEMPLATE.md", "NEXT_100.md", "THESIS_OUTLINE.md", "VERIFICATION_PLAN.md", "tables.md", "THESIS_DRAFT.md", "COURSE_SYLLABUS.md"}:
