...
@pytest.mark.parametrize("name", ["thermal_explorer", "link_loss_explorer", "light_time_explorer",
                                  ...
                                  "repeater_rate_explorer", "mars_light_time_cycle", "modality_radar", "surface_code_lattice", "qkd_protocols_explorer", "memory_crossover", "relay_constellation_explorer", "messenger_latency", "purification_recurrence", "repeater_generations", "cat_state_wigner"])
